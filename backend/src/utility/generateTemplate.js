                                  ...
                                  <td class="pad">
                                    <div style="font-family: sans-serif">
                                      <div class style="font-size: 14px; mso-line-height-alt: 16.8px; color: #506bec; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:38px;"><strong>Hi ${user?.firstName},</strong></span></p>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                                  ...
                                  <td class="pad">
                                    <div style="font-family: sans-serif">
                                      <div class style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                        <p style="margin: 0; mso-line-height-alt: 16.8px;"><span style="font-size:16px;">Your Password Reset Request is Received.</span></p>
                                        <p style="margin: 0; mso-line-height-alt: 16.8px;">&nbsp;</p>
                                        <p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;"><span style="font-size:16px;">The One Time Password (OTP) to reset your password is <strong>${randomOTP}</strong>.&nbsp;</span></p>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
...
const companyTemplateNew = async( oldProgress, newProgress, companyName, oldStatus, newStatus, sevenDaysAgoArray, weekEndDateArray) => {
  ...
  * {
  ...
  <div align="center">
    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Cabin',sans-serif;"><tr><td style="font-family:'Cabin',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${config.PROD_ORIGIN}/okr" style="height:37px; v-text-anchor:middle; width:188px;" arcsize="11%" stroke="f" fillcolor="#3AAEE0"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
